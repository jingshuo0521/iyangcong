...
public class OpenDictionaryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myArticleView.getSettings().setSavePassword(false);
		myArticleView.removeJavascriptInterface("searchBoxJavaBridge_");
		myArticleView.removeJavascriptInterface("accessibility");
		myArticleView.removeJavascriptInterface("accessibilityTraversal");
