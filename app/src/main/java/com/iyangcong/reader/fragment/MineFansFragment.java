...
public class MineFansFragment extends BaseFragment {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_fans_list, container, false);
        ...
        MineFansListAdatper tmpAdatper = new MineFansListAdatper(mContext, mFansBeanList);
        ...
        mRvFanslist.setLayoutManager(new LinearLayoutManager(mContext));
    ...
    private void getFanlist() {
        OkGo.get(Urls.URL + "/personCenter/getAttentionUserPersonInfoList")
                ...
                .execute(new JsonCallback<IycResponse<List<FansBean>>>(mContext) {
                    @Override
