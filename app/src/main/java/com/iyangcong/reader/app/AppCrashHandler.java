...
//            public void run() {
//                Looper.prepare();
//                //UIHelper.showFriendlyMsg(mContext, "很抱歉,程序出现异常,即将退出.");
//                ToastCompat.makeText(mContext, "很抱歉,程序出现异常,即将退出.", Toast.LENGTH_SHORT).show();
//                Looper.loop();
//            }
//        }.start();
        //收集设备参数信息
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path =Environment.getExternalStorageDirectory().getPath()+"/iyangcong/logs/";
