...
import com.iyangcong.reader.adapter.FansAdapter;
...
public class FansActivity extends SwipeBackActivity implements View.OnClickListener{
    ...
    protected void initView() {
        FansAdapter tmpAdatper = new FansAdapter(this, mFansBeanList,touserId);
