    ...
    protected void initView() {
        ...
        mineCollectionListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MineCollectionActivity.this, BookMarketBookDetailsActivity.class);
...
//        });
    ...
    protected void setMainHeadView() {
        textHeadTitle.setText(getResources().getString(R.string.mine_collection));
...
//        mineCollectionPtrClassicFrameLayout.autoRefresh();
    ...
    private void getDatasFromNetwork() {
        ...
        if (hj){
            OkGo.get(PersonCollectBookListURL)
                    .tag(this)
