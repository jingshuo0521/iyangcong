...
public class BookMarketAdapter extends RecyclerView.Adapter {
    ...
    public BookMarketAdapter(Context context, MarketContent bookMarket) {
    ...
    public BookMarketAdapter(Context context, MarketContent bookMarket, CustomPtrClassicFrameLayout ptrClassicFrameLayout) {
...
//            banner.setParentView(ptrClassicFrameLayout);
    ...
    public class BookTypeViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(final MarketRecommend bookRecommend) {
            ...
            if (bookRecommend == null) {
                ...
                lp.leftMargin = DisplayUtil.dip2px(context,5);
                lp.rightMargin = DisplayUtil.dip2px(context,5);
                lp.topMargin = DisplayUtil.dip2px(context,5f);
                lp.height = DisplayUtil.dip2px(context,80);
    ...
    public class TodayBookViewHolder extends RecyclerView.ViewHolder {
        ...
        private TodayBookViewHolder(Context context, View inflate) {
            ...
            TextPaint paint = tvGeneralReadTittle.getPaint();
            paint.setStyle(Paint.Style.FILL_AND_STROKE);
            paint.setStrokeWidth(1);
            paint = tvHotBookTittle.getPaint();
            paint.setStyle(Paint.Style.FILL_AND_STROKE);
            paint.setStrokeWidth(1);
            paint = tvFreeBookTittle.getPaint();
            paint.setStyle(Paint.Style.FILL_AND_STROKE);
            paint.setStrokeWidth(1);
        }
        ...
        void setData(MarketRecommend bookRecommend) {
            if (bookRecommend == null) {
                ...
                tvGeneralReadTittle.setText(bookRecommend.getTongshi().getTitle());
                tvFreeBookTittle.setText(bookRecommend.getFree().getTitle());
                tvHotBookTittle.setText(bookRecommend.getHot().getTitle());
                tvGeneralReadIntroduction.setText(bookRecommend.getTongshi().getContent());
                tvFreeBookIntroduction.setText(bookRecommend.getFree().getContent());
                tvHotBookIntroduction.setText(bookRecommend.getHot().getContent());
