 ...
 * 通用版块布局适配器
 */
public class BFSURecommendAdapter extends RecyclerView.Adapter {
    ...
    public BFSURecommendAdapter(Context mContext, List<MarketBookListItem> bookList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == BOOK_INTRODUCTION_BOOK) {
            return new BFSURecommendAdapter.BookViewHolder(mContext, mLayoutInflater.inflate(R.layout.item_book_introduction, null));
        } else if (viewType == BOOK_INTRODUCTION_IMAGE) {
            return new BFSURecommendAdapter.ImageViewHolder(mContext, mLayoutInflater.inflate(R.layout.item_book_image, null));
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == BOOK_INTRODUCTION_BOOK) {
            BFSURecommendAdapter.BookViewHolder bookViewHolder = (BFSURecommendAdapter.BookViewHolder) holder;
            bookViewHolder.setData(bookList.get(position));
        } else if (getItemViewType(position) == BOOK_INTRODUCTION_IMAGE) {
            BFSURecommendAdapter.ImageViewHolder imageViewHolder = (BFSURecommendAdapter.ImageViewHolder) holder;
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(final MarketBookListItem book) {
            GlideImageLoader.displaysetdefault(mContext, ivBookImage, book.getImgUrl(), R.drawable.pic_default_special_topic);
