...
import com.iyangcong.reader.activity.ImagePreviewsActivity;
...
public class ImagePreviewAdapter extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        GlideImageLoader.displaysetdefault(view.getContext(), imageView, info.bigImageUrl, R.drawable.pic_default_topic);
    ...
    private void showExcessPic(ImageInfo imageInfo, PhotoView imageView) {
        ...
        //如果大图的缓存不存在,在获取小图的缓存
        if (cacheImage == null&&NineGridView.getImageLoader()!=null)
    ...
    public void onPhotoTap(View view, float x, float y) {
        ((ImagePreviewsActivity) context).finishActivityAnim();
    }
}
