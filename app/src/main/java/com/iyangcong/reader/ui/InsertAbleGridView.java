...
public class InsertAbleGridView extends ViewGroup implements CanMergeView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.anarchy.classify.R.styleable.InsertAbleGridView, defStyleAttr, com.anarchy.classify.R.style.InsertAbleGridViewDefaultStyle);
        mRowCount = a.getInt(com.anarchy.classify.R.styleable.InsertAbleGridView_RowCount, 2);
        mColumnCount = a.getInt(com.anarchy.classify.R.styleable.InsertAbleGridView_ColumnCount, 2);
        mRowGap = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.InsertAbleGridView_RowGap, 10);
        mColumnGap = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.InsertAbleGridView_ColumnGap, 10);
        mOutLinePadding = a.getDimensionPixelSize(R.styleable.InsertAbleGridView_OutlinePadding, 0);
