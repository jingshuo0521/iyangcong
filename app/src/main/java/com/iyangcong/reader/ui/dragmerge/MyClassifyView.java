package com.iyangcong.reader.ui.dragmerge;
...
import com.anarchy.classify.ClassifyDragShadowBuilder;
import com.anarchy.classify.ClassifyItemAnimator;
import com.anarchy.classify.DragDrawable;
...
public class MyClassifyView extends FrameLayout {
    ...
    public MyClassifyView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public MyClassifyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public MyClassifyView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyClassifyView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.anarchy.classify.R.styleable.ClassifyView, defStyleAttr, com.anarchy.classify.R.style.DefaultStyle);
        mSubRatio = a.getFraction(com.anarchy.classify.R.styleable.ClassifyView_SubRatio, 1, 1, 0.7f);
        mMainSpanCount = a.getInt(com.anarchy.classify.R.styleable.ClassifyView_MainSpanCount, 3);
        mSubSpanCount = a.getInt(com.anarchy.classify.R.styleable.ClassifyView_SubSpanCount, 3);
        mAnimationDuration = a.getInt(com.anarchy.classify.R.styleable.ClassifyView_AnimationDuration, 200);
        mEdgeWidth = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_EdgeWidth, 15);
        mDragScaleX = a.getFloat(com.anarchy.classify.R.styleable.ClassifyView_DragScaleX,1f);
        mDragScaleY = a.getFloat(com.anarchy.classify.R.styleable.ClassifyView_DragScaleY,1f);
        mDragInMergeScaleX = a.getFloat(com.anarchy.classify.R.styleable.ClassifyView_DragInMergeScaleX,1f);
        mDragInMergeScaleY = a.getFloat(com.anarchy.classify.R.styleable.ClassifyView_DragInMergeScaleY,1f);
        mGravity = a.getInt(com.anarchy.classify.R.styleable.ClassifyView_DragScalePivotGravity,LEFT_TOP);
        int mainPadding = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_MainPadding,0);
        int mainPaddingLeft = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_MainPaddingLeft,0);
        int mainPaddingTop = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_MainPaddingTop,0);
        int mainPaddingRight = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_MainPaddingRight,0);
        int mainPaddingBottom = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_MainPaddingBottom,0);
        boolean mainClipToPadding = a.getBoolean(com.anarchy.classify.R.styleable.ClassifyView_MainClipToPadding,true);
        int subPadding = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_SubPadding,0);
        int subPaddingLeft = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_SubPaddingLeft,0);
        int subPaddingTop = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_SubPaddingTop,0);
        int subPaddingRight = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_SubPaddingRight,0);
        int subPaddingBottom = a.getDimensionPixelSize(com.anarchy.classify.R.styleable.ClassifyView_SubPaddingBottom,0);
        boolean subClipToPadding = a.getBoolean(com.anarchy.classify.R.styleable.ClassifyView_SubClipToPadding,true);
        a.recycle();
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (pointerId == mMainActivePointerId) {
                    if (mMainCallBack.canDragOnLongPress(position, pressedView)) {
                        ...
                        Log.e("test","mSelectedStartX:" + mSelectedStartX);
                        Log.e("test","mSelectedStartY:" + mSelectedStartY);
                        Log.e("test","mInitialTouchX:" + mInitialTouchX);
                        Log.e("test","mInitialTouchY:" + mInitialTouchY);
                ...
                if (pointerId == mSubActivePointerId) {
                    if (mSubCallBack.canDragOnLongPress(position, pressedView)) {
                        ...
                        for (DragListener listener : mDragListeners) {
                            listener.onDragStart(MyClassifyView.this,mSelected,mInitialTouchX, mInitialTouchY, IN_MAIN_REGION);
                        }
...
//                        Log.e("test","y:"+y);
                        ...
                        if (mMoveListenerEnable) {
                            for (DragListener listener : mDragListeners) {
                                listener.onMove(MyClassifyView.this, x, y, IN_SUB_REGION);
                            }
                        }
                        break;
                    case MotionEvent.ACTION_CANCEL:
                    case MotionEvent.ACTION_UP:
                        ...
                        if ((mRegion &IN_SUB_REGION) != 0) {
                            ...
                            mState = STATE_SETTLE;
                            for (DragListener listener : mDragListeners) {
                                listener.onDragRelease(MyClassifyView.this, x, y, IN_SUB_REGION);
                            }
                        }
                        if ((mRegion & IN_MAIN_REGION)!= 0) {
                            ...
                            mState = STATE_SETTLE;
                            for (DragListener listener : mDragListeners) {
                                listener.onDragRelease(MyClassifyView.this, x, y, IN_MAIN_REGION);
                            }
                        }
    ...
    protected Dialog createSubDialog() {
        Dialog dialog = new Dialog(getContext(), com.anarchy.classify.R.style.ClassifyViewTheme);
    ...
    protected ViewGroup findHaveSubTagContainer(ViewGroup group) {
        String tag = getContext().getString(com.anarchy.classify.R.string.sub_container);
    ...
    protected View getSubContent() {
        return inflate(getContext(), com.anarchy.classify.R.layout.sub_content, null);
    }
     ...
     */
    class MainDragListener implements OnDragListener {
        @Override
...
//            L.d("Main onDrag X:%1$s,Y:%2$s", x, y);
            float centerX = x - width /2;//2/3
            float centerY = y - height/2;//4/5
            switch (action) {
...
//                    Log.e("test","y:"+y);
                    ...
                    if (mMoveListenerEnable) {
                        for (DragListener listener : mDragListeners) {
                            listener.onMove(MyClassifyView.this, x, y, IN_MAIN_REGION);
                        }
                    }
                    break;
                ...
                mDragView.animate()
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if(mPendingRecover){
                            ...
                            for(DragListener listener:mDragListeners){
                                listener.onDragStartAnimationEnd(MyClassifyView.this,selected,mRegion);
                            }
                        }
                    }
    ...
    private AnimatorListenerAdapter mRecoverAnimatorListener = new AnimatorListenerAdapter() {
        ...
        public void onAnimationEnd(Animator animation) {
            for (DragListener listener : mDragListeners) {
                listener.onDragEnd(MyClassifyView.this, mRegion);
            }
            restoreToInitial();
        }
    ...
    private boolean scrollIfNecessary() {
        ...
        if (lm.canScrollVertically()) {
            ...
            int curY = (int) (mDy + mInitialTouchY);
            final int topDiff = curY - mSelected.getHeight()/3 - mEdgeWidth - recyclerView.getPaddingTop();
            if (mDy < 0 && topDiff < 0) {
                scrollY = topDiff;
            } else if (mDy > 0) {
        ...
        //Log.e("test","scrollX:"+scrollX);
        //Log.e("test","scrollY:"+scrollY);
        if (scrollY != 0) {
    ...
    private int getMaxDragScroll(RecyclerView recyclerView) {
        if (mCachedMaxScrollSpeed == -1) {
            mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(
                    com.anarchy.classify.R.dimen.item_touch_helper_max_drag_scroll_per_frame);
        }
    ...
    private final Runnable mScrollRunnable = new Runnable() {
        ...
        public void run() {
            if (mSelected != null && scrollIfNecessary()) {
                ...
                removeCallbacks(mScrollRunnable);
                ViewCompat.postOnAnimation(MyClassifyView.this, this);
            } else {
                inScrollMode = false;
            }
        }
    ...
    private void moveIfNecessary(View view) {
        final int x = (int) (mDx + mInitialTouchX -view.getWidth()/2);
        final int y = (int) (mDy + mInitialTouchY -view.getHeight()/2);
//        Log.e("test","x2:"+x);
//        Log.e("test","y2:"+y);
        //如果移动范围在自身范围内
...
//        for(int ii = 0; ii < swapTargets.size(); ii++){
//            Log.e("test","候选" +ii+"号:" + mSubRecyclerView.getChildAdapterPosition(swapTargets.get(ii)));
//        }
        ...
        if ((mRegion & IN_MAIN_REGION) != 0) {//在主层级下 有merge状况 以及次级目录拖动到主层级的状况
            ...
            //Log.e("test","targetPosition:" + targetPosition);
...
//            Log.e("test","0");
//            if(mergeState){Log.e("test","1");}
//            if(!inMergeState){Log.e("test","2");}
//            if(mergeState ^ inMergeState){Log.e("test","3");}
...
//        int top = Math.round(mSelectedStartY + mDy);
        int left = Math.round(mDx + mInitialTouchX -view.getWidth()/2);
        int top = Math.round(mDy + mInitialTouchY -view.getHeight()/2);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //Log.e("test","原始targetPosition"+ targetPosition);
            //检验目标位置是否能移动
            if ((mRegion & IN_MAIN_REGION) != 0) {
