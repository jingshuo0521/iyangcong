package com.iyangcong.reader.ui.button;
...
/**
 * 描述：FlatButton  常用按钮，支持平面效果，立体阴影效果
 * 作者：chenkeliang on 2016-09-28
 */
...
public class FlatButton extends Button implements View.OnTouchListener {
    ...
    private void init() {
        ...
        mShadowColor = resources.getColor(R.color.status_bar_bg);
        mShadowHeight = 0;
        mCornerRadius = resources.getDimensionPixelSize(R.dimen.space_20);
    }
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FlatButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getColor(attr, getResources().getColor(R.color.button_color));
            } else if (attr == R.styleable.FlatButton_shadowColor) {
                mShadowColor = typedArray.getColor(attr, getResources().getColor(R.color.status_bar_bg));
                ...
                mCornerRadius = typedArray.getDimensionPixelSize(attr, R.dimen.space_8);
            }
        }
        typedArray.recycle();
     ...
     * @param color
     */
    public void enable(int color) {
        super.setEnabled(true);
        this.setButtonColor(getResources().getColor(color));
        refresh();
    }
    ...
    public void disable() {
        ...
        this.setButtonColor(getResources().getColor(R.color.lightgray));
        refresh();
    }
