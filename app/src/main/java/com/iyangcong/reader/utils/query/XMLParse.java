...
public class XMLParse extends DefaultHandler {
	...
	public void startElement(String namespaceURI, String localName,
		...
		if (localName.equals("main")) {
			...
			if(className.equals("hw")){
				localName = "word";
			}else if(className.equals("pron")){
				localName = "phonetic";
			}

			Logger.i("hahahaha className:" + className);
		}else if(localName.equals("dl")){

		}else if(localName.equals("x-gram")){
	...
	public void characters(char[] ch, int start, int length)
		...
		if (tagName != null) {
			...
			if(tagName.equals("hyph")){
			//不知道这个解析出来放到word的哪个字段？
			}
