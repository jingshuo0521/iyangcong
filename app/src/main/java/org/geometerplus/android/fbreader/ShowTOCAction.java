...
class ShowTOCAction extends FBAndroidAction {
    ...
    protected void run(Object... params) {
        ...
        final Intent internalIntent =
                new Intent(BaseActivity.getApplicationContext(), CatalogActivity.class);
    ...
    private void startBookmarksActivity(Intent intent) {
        ...
        SharedPreferenceUtil.getInstance().putInt(SharedPreferenceUtil.CHAPTERID,BookInfoUtils.getRelativeChapterId(Reader,BaseActivity.getApplicationContext()));
