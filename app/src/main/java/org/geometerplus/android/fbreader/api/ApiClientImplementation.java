...
public class ApiClientImplementation implements ServiceConnection, Api, ApiMethods {
	...
	public synchronized void connect() {
		if (myInterface == null) {
			...
			myContext.registerReceiver(myEventReceiver, new IntentFilter(FBReaderIntents.Action.API_CALLBACK),FBReaderIntents.Event.CUSTOM_BROADCAST_PSERMISSION,null);
		}
	}
