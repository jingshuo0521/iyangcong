...
/**
 * author:WuZepeng </br>
 * time:2017-09-25 17:31 </br>
 * desc:获取配置信息的工具类，通过跨进程通信获取到运行在ConfigService中的SQLiteConfig信息 </br>
 */
public final class ConfigShadow extends Config implements ServiceConnection {
	private final Context myContext;
	private volatile ConfigInterface myInterface;//跨进程通信的Binder
	...
	public void onServiceConnected(ComponentName name, IBinder service) {
		synchronized (this) {
			...
			myContext.registerReceiver(
				myReceiver, new IntentFilter(FBReaderIntents.Event.CONFIG_OPTION_CHANGE),FBReaderIntents.Event.CUSTOM_BROADCAST_PSERMISSION,null
			);
		}
