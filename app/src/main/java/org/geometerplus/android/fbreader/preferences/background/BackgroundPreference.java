...
public class BackgroundPreference extends Preference {
	...
	public BackgroundPreference(Context context, ColorProfile profile) {
		this(context, profile, null, 0);
	}
	...
	public void update(){
		myProfile.BackgroundOption.setValue(new ZLColor(SharedPreferenceUtil.getInstance().getInt(SharedPreferenceUtil.CURRENT_BACKGROUND_COLOR, 0)));
		notifyChanged();
	}
}
