...
public abstract class AnimationProvider {
	...
	public final void drawHeadBitmap(Canvas canvas, Bitmap headBitmap, int voffset){
		setFilter();
		drawHeadBitmapInternal(canvas, headBitmap,voffset);
	}
	...
	protected abstract void drawHeadBitmapInternal(Canvas canvas, Bitmap footerBitmap, int voffset);
