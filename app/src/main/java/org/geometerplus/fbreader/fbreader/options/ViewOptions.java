...
public class ViewOptions {
	...
	public final ZLIntegerRangeOption HeadHeight;
	...
	public ViewOptions() {
		...
		FooterHeight =
			new ZLIntegerRangeOption("Options", "FooterHeight", 0, dpi / 3, 50);
		HeadHeight =
				new ZLIntegerRangeOption("Options", "HeadHeight", 0, dpi / 3, 80);
		ColorProfileName =
