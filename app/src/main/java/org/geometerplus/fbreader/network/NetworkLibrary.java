...
public class NetworkLibrary {
	...
	public static NetworkLibrary Instance(org.geometerplus.zlibrary.core.util.SystemInfo systemInfo) {
		if (ourInstance == null) {
	...
	public final ZLStringOption NetworkSearchPatternOption =
		new ZLStringOption("NetworkSearch", "PatternUtils", "");

	public final org.geometerplus.zlibrary.core.util.SystemInfo SystemInfo;
	...
	private NetworkLibrary(org.geometerplus.zlibrary.core.util.SystemInfo systemInfo) {
