...
public class AuthorTree extends FilteredTree {
	...
	AuthorTree(IBookCollection collection, org.geometerplus.fbreader.formats.PluginCollection pluginCollection, org.geometerplus.fbreader.book.Author author) {
