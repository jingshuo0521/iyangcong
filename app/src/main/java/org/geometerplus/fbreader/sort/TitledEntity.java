...
/**
 * author:WuZepeng </br>
 * time:2018-01-22 17:25 </br>
 * desc:标题化的实体类？？？主要用来描述书的标题的特点 </br>
 */
public abstract class TitledEntity<T extends TitledEntity<T>> implements Comparable<T> {
	...
	private String mySortKey;//2018-01-22 这个字段大概是用来搜索或者排序用的；
...
//		Logger.e("wzp 被C++调用了 获取书名：：%s",myTitle);
	...
	//normalize方法有助于通过将文本转换为规范组合和分解形式
