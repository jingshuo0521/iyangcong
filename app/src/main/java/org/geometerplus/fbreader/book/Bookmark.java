...
public final class Bookmark extends ZLTextFixedPosition {
	...
	/**
	 * 这个类构造器主要用在当中英文的段落数量不一致的情况下使用。
	 * 政治学这本书，中文段落共99段，英文共149段。在阅读了英文中段落号超出中文的段落号的段落，切换到中文以后，会发生段落溢出。
	 * 这个构造器用来复制溢出段落对应的书签的内容，但需要重新设置段落Id,start_paragraphIndex和end_paragraphIndex可以是一个段落；
	 * @param original
	 * @param start_paragraphIndex
	 * @param start_elementIndex
	 * @param start_charIndex
	 * @param end_paragraphIndex
	 * @param end_elementIndex
	 * @param end_charIndex
	 */
	public Bookmark(Bookmark original,int start_paragraphIndex, int start_elementIndex, int start_charIndex,
