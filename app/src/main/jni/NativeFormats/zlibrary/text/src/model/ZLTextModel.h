...
*/
	...
	const std::vector<jbyte> &paragraphTags() const;
protected:
...
private:
	...
	std::vector<jbyte> myParagraphTags;
...
inline const std::vector<jbyte> &ZLTextModel::paragraphTags() const {return myParagraphTags;}
