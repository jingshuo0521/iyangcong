...
public:
	...
	ParagraphTag mPTag;
	void setParagraphTag(ParagraphTag tag);
	ParagraphTag getParagraphTag();
...
inline ZLTextParagraph::ParagraphTag  ZLTextParagraph::getParagraphTag() {return mPTag;}
inline void ZLTextParagraph::setParagraphTag(ParagraphTag tag) {mPTag = tag;}
