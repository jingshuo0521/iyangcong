...
//shared_ptr<StringMethod> AndroidUtil::StaticMethod_NativeFormatPlugin_methodCalledByJni;
...
bool AndroidUtil::init(JavaVM* jvm) {
    ...
    //StaticMethod_NativeFormatPlugin_methodCalledByJni1 = new StaticObjectMethod(Class_NativeFormatPlugin, "methodCalledByJni1", Class_NativeFormatPlugin, "(Ljava/lang/String;Ljava/lang/String;)");
	...
	Method_BookModel_createTextModel = new ObjectMethod(Class_BookModel, "createTextModel", Class_ZLTextModel, "(Ljava/lang/String;Ljava/lang/String;I[I[I[I[I[B[BLjava/lang/String;Ljava/lang/String;I)");
