...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode()) {
            ...
            if(screenWidth==720){
                //720p
                width = (int) (675*(720.0f/1080.0f));
                height = (int) (675*(720.0f/1080.0f));
            }
            int leftOffset = (screenWidth - width) / 2;
            int topOffset = (screenHeight - height - 600) / 2;
            if(screenWidth==720){
                topOffset = (screenHeight - height - (int) (650*(720.0f/1080.0f))) / 2;
            }
...
//            paint.setColor(frameColor);
    ...
    private void drawScanner(Canvas canvas, Rect frame) {
        if (showPossiblePoint) {
            ...
            paint.setColor(Color.parseColor("#ff8044"));
            scannerAlpha = (scannerAlpha + 1) % SCANNER_ALPHA.length;
            ...
            int screenWidth = getResources().getDisplayMetrics().widthPixels;
            if(screenWidth==720){
                if (translateY >= (int) (670*(720.0f/1080.0f))) {
                    translateY = 5f;
                }
            }else {
                if (translateY >= 670) {
